...
} from "@models/globalBannerStats/entities/stats/overview/OverviewArsenalTicketStatsData.js";
...
export interface GlobalBannerDataWeaponV2 {
    type: GlobalBannerDataType.WEAPON_V2;
    stats: {
        featured: FeaturedStatsData & FeaturedGuaranteedStatsData;
        overview: OverviewStatsData & OverviewArsenalTicketStatsData;
        stats6: Stats6Data & Stats6WinrateData;
        stats5: Stats5Data & Stats5PityData;
    };

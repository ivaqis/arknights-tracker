...
import type { GlobalBannerDataRerun } from "$lib/api/globalBannerStats/contracts/GlobalBannerDataRerun";
...
import type { GlobalBannerDataWeaponRerun } from "$lib/api/globalBannerStats/contracts/GlobalBannerDataWeaponRerun";

<script>
    ...
    function getClasses(styleMode) {
        switch (styleMode) {
            ...
            case "dragged":
                return "bg-gray-300 border-[#f9b90c] text-black dark:text-[#E0E0E0] dark:bg-[#424242] opacity-50";
            case "default":
            default:
...
<div class="h-[32px] px-2 rounded flex items-center gap-1.5 border transition-all {getClasses(styleMode)}">

...
{#if !equipment[id]}
    <NotFound />
{:else}
<div class="{showBackButton ? 'min-h-screen md:px-4 md:py-3' : 'md:px-1 md:py-1 pb-10'} font-sans transition-colors">
    {#if showBackButton}
    ...
    <div
        class="w-full max-w-[1500px] mx-auto grid grid-cols-1 {showBackButton ? 'xl:grid-cols-12' : 'grid-cols-1'} gap-8 items-start"
    >
                                        ...
                                        >
                                            <div class="relative w-[42px] h-[42px] shrink-0">
                                                <WeaponCard
                                                    ...
                                                    hideRarity={true}
                                                    disableHover={true}
                                                    onClick={onSelectEquipment ? () => onSelectEquipment(match.id) : undefined}
                                                />
                                                {#if match.id === id}
                                                    <span

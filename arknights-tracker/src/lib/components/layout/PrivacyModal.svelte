...
<Modal {isOpen} on:close={onClose}>
  <div
    class="relative bg-white rounded-2xl dark:bg-[#383838] dark:border-[#444444] p-6 md:p-8 w-[calc(100vw-2rem)] md:w-full max-w-3xl shadow-2xl border border-gray-100 flex flex-col max-h-[90vh]"
  >

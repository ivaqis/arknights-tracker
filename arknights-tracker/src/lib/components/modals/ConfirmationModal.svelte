...
<Modal {isOpen} closeOnOutsideClick={false} on:close={onClose}>
  <div
    class="relative bg-white rounded-2xl dark:bg-[#383838] dark:border-[#444444] p-6 w-full max-w-md shadow-2xl border border-gray-100 cursor-auto"
